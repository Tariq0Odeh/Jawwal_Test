Public Class frmMenuEKYC
    ...
    Private Sub LoadPanelBackGround()
        ...
        ExceptionLogger.LogInfo("frmMenuEKYC_Load : Trying to BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch")
    ...
    Private Sub frmMenu_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            ExceptionLogger.LogInfo("Failed to load Image Background for pnlWA in frmMenuEKYC_Load")
            ...
            While (True)
                ...
                Catch ex2 As Exception
                    ExceptionLogger.LogInfo("Failed " & counter & " times to load Image Background for pnlWA in frmMenuEKYC_Load")
        ...
        ExceptionLogger.LogInfo("frmMenuEKYC -> frmMenuEKYC_Load ")
    ...
    Private Sub btnsimswap_click(sender As Object, e As EventArgs) Handles btnSIMSwap.Click
    ...
    Private Sub btnNewSIM_Click(sender As Object, e As EventArgs) Handles btnNewSIM.Click
        ...
        CurrentTransaction = New Transaction
        CurrentTransaction.TransactionReference = objConfigParams.TerminalId & Date.Now.ToString("yyMMddHHmmss")
        CurrentTransaction.TransactionType = "NewSim"
        CurrentTransaction.TerminalId = objConfigParams.TerminalId
        CurrentTransaction.TransactionDateTime = Date.Now.ToString("dd/MM/yyyy HH:mm:ss")
        CurrentTransaction.TransactionStatus = "Inprogress"

        Dim obj As New frmNewSim
        CurrentServiceForm = obj
        obj.ShowDialog()
        CurrentServiceForm = Nothing
...
#End Region
    ...
    Private Sub frmMenu_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        ExceptionLogger.LogInfo("frmMenu -> frmMenu_FormClosing ")


        ExceptionLogger.LogInfo("***frmMain is trying to close...")
