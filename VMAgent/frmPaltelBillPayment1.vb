...
Public Class frmPaltelBillPayment1
    ...
    Private Sub LoadPanelBackGround()
        ...
        ExceptionLogger.LogInfo("frmPaltelBillPayment1_Load : Trying to BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch")
        Me.pnlWA.BackgroundImage = Global.VMAgent.My.Resources.Resources.frmPaltelBillPayment1
    ...
    Private Sub frmPaltelBillPayment1_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            ExceptionLogger.LogInfo("Failed to load Image Background for pnlWA in frmPaltelBillPayment1_Load")
            ...
            Catch ex2 As Exception
                ExceptionLogger.LogInfo("Failed second time to load Image Background for pnlWA in frmPaltelBillPayment1_Load")
